...
onMounted(() => {
  ...
  let i = 0;
  let timer: any = null;
  htmltemp.value.childNodes[0].innerText = "";
  console.log(htmltemp.value.childNodes[4].childNodes[0].innerText);
  timer = setInterval(() => {
    htmltemp.value.childNodes[0].innerText += tempstr.charAt(i);
    i++;
