<template>
  <div class="w-[51vw] h-[100%] bg-rg-chat rounded-[30px] flex">
    <div class="flex flex-col w-[34vw] h-[100%] border-r-2 border-indigo-500">
      ...
      <div
        class="flex flex-col justify-end items-center w-[100%] h-[100%] p-4 pb-10 overflow-y-auto"
      >
        <div
          class="w-[95%] text-start bg-rg-chat-border text-stone-300 rounded-[20px] p-6 pb-16"
        >
          {{ text }}
