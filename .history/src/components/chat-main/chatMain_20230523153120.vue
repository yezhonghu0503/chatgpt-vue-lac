    ...
    <div class="flex flex-col w-[34vw] h-[100%] border-r-2 border-indigo-500">
      ...
      >
        <div class="w-[95%] h-[70vh] text-start p-4 pl-0 overflow-auto">
          ...
          >
            <div ref="htmltemp" class="" v-html="renderHTML"></div>
            <img
          ...
          >
            <div ref="htmltemp" class="" v-highlight v-html="renderHTML"></div>
            <img
...
const changeHtml = () => {
  // Prism.highlightElement(htmltemp);
