    ...
    <div class="flex flex-col w-[34vw] h-[100%] border-r-2 border-indigo-500">
      ...
      <div class="flex flex-col justify-end items-center w-[100%] h-[100%] p-4">
        ...
        >
          ...
          <textarea
            class="resize-none w-full px-4 py-2 leading-normal bg-white rounded-lg border border-gray-300 appearance-none focus:outline-none focus:shadow-outline-gray"
            rows="4"
          ></textarea>
          <img
            class="w-[25px] h-[25px]"
